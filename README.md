...
- After install, open `.env` in the app folder and paste in your real `EMAIL_PASS` and `AWS_BEARER_TOKEN_BEDROCK` — these are **never** written automatically or stored in the repo
